...
public class MP_Join extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mp_join);
        hideSystemBars();
    }
    ...
    public void btn_Join(View v){
        Intent mp_groupList = new Intent(MP_Join.this, MP_GroupList.class);
    ...
    public void btn_Profile(View v){
        Intent mp_profile = new Intent(MP_Join.this, MP_Profile.class);
